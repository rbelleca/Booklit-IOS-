...
class PhysicsSell extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _PhysicsSellState();
  }
}

class _PhysicsSellState extends State<PhysicsSell> {
...
class PhysicsSellersList {
  String key;
  String userName;
  String contactInfo;

  PhysicsSellersList(this.userName, this.contactInfo);

  PhysicsSellersList.fromSnapshot(DataSnapshot snapshot)
      : key = snapshot.key,
